    ...
    <section className="bg-anchor section-y relative overflow-hidden">
      ...
      <div className="container-page relative">
        ...
        <div className="text-center mb-14 lg:mb-18">
          ...
          <p className="text-on-brand text-[26px] sm:text-[32px] lg:text-[38px] font-normal leading-[1.15] tracking-[-0.02em] m-0">
            Um processo simples e transparente
          </p>
          <p className="text-on-brand-soft text-[22px] sm:text-[28px] lg:text-[34px] font-normal leading-[1.15] tracking-[-0.02em] mt-1.5 m-0">
            do início ao fim
          </p>
        </div>
              ...
              <div key={i} className="text-center relative z-10">
                <div className="flex justify-center mb-5 lg:mb-7">
                  <div className="relative">
                    {/* Circle */}
                    <div
                      className="w-[88px] h-[88px] lg:w-28 lg:h-28 rounded-full border-[1.5px] border-on-brand-soft flex items-center justify-center"
                    ...
                    {/* Step number badge */}
                    <span className="absolute -top-1 -right-1 w-[26px] h-[26px] rounded-full bg-on-brand flex items-center justify-center text-brand text-[11px] font-extrabold leading-none">
                      {i + 1}
                    </span>
                  </div>
                </div>

                <h3 className="text-on-brand text-base font-bold mb-3">
                  {step.title}
                </h3>
                <p className="text-on-brand-soft text-sm leading-[1.7] m-0">
                  {step.description}
                </p>
              </div>
            );
